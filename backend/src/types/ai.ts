...
/** 泛化设备连接上下文（替代 RouterOSConnectionContext） */
...
/** 泛化设备系统信息（替代 RouterOSSystemInfo） */
...
export interface ScriptExecuteRequest {
  ...
  routerosClient?: import('../services/routerosClient').RouterOSClient;
  /** 泛化设备支持：目标设备 ID */
  deviceId?: string;
}
 ...
 * RouterOS 系统提示词模板
 */
export const ROUTEROS_SYSTEM_PROMPT = `你是 RouterOS 智能运维助手，专注于 MikroTik RouterOS 网络设备的智能运维管理。你的职责是：
